...
namespace com.amazon.device.iap.cpt 
{
    ...
    public delegate void LicenseResponseDelegate(LicenseResponse eventName);
    ...
    public interface IAmazonIapV2
    {
        ...
        RequestOutput VerifyLicense();
        GetAppstoreSDKModeOutput GetAppstoreSDKMode();
        ...
        void AddLicenseResponseListener (LicenseResponseDelegate responseDelegate);
        void RemoveLicenseResponseListener (LicenseResponseDelegate responseDelegate);
#if __ANDROID__
