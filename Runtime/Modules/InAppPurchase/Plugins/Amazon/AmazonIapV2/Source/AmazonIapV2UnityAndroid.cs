...
namespace com.amazon.device.iap.cpt
{
    public abstract partial class AmazonIapV2Impl
    {
        ...
        private class AmazonIapV2UnityAndroid : AmazonIapV2UnityBase
        {
            ...
            [DllImport ("AmazonIapV2Bridge")]
            private static extern string nativeVerifyLicenseJson(string jsonMessage);

            [DllImport ("AmazonIapV2Bridge")]
            private static extern string nativeGetAppstoreSDKModeJson(string jsonMessage);
            ...
            protected override string NativeVerifyLicenseJson(string jsonMessage)
            {
                return AmazonIapV2UnityAndroid.nativeVerifyLicenseJson(jsonMessage);
            }

            protected override string NativeGetAppstoreSDKModeJson(string jsonMessage)
            {
                return AmazonIapV2UnityAndroid.nativeGetAppstoreSDKModeJson(jsonMessage);
            }
