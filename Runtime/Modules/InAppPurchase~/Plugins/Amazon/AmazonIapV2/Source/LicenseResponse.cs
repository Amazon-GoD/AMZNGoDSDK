...
{
    public sealed class LicenseResponse : Jsonable
    {
        ...
        public static LicenseResponse CreateFromDictionary(Dictionary<string, object> jsonMap) 
        {
            try 
            {
                if (jsonMap == null)
                ...
                var request = new LicenseResponse();
        ...
        public static LicenseResponse CreateFromJson(string jsonMessage)
        {
            try 
            {
        ...
        public static Dictionary<string, LicenseResponse> MapFromJson(Dictionary<string, object> jsonMap)
        {
            Dictionary<string, LicenseResponse> result = new Dictionary<string, LicenseResponse>();
            foreach (var entry in jsonMap)
            {
                LicenseResponse value = CreateFromDictionary(entry.Value as Dictionary<string, object>);
                result.Add(entry.Key, value);
            }
            return result;
        }
        
        public static List<LicenseResponse> ListFromJson(List<object> array)
        {
            List<LicenseResponse> result = new List<LicenseResponse>();
